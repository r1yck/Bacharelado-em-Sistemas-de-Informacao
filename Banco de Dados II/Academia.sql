...
CREATE TABLE IF NOT EXISTS Pessoa_Associada (
...
CREATE TABLE IF NOT EXISTS Pessoa_Treinadora (
...
CREATE TABLE IF NOT EXISTS Treino (
    ...
    FOREIGN KEY (Pessoa_Associada_ID)
        REFERENCES Pessoa_Associada (Pessoa_Associada_ID),
    FOREIGN KEY (Modalidade_ID)
        REFERENCES Modalidade (Modalidade_ID),
...
CREATE TABLE IF NOT EXISTS Aula (
    ...
    FOREIGN KEY (Pessoa_Treinadora_ID)
        REFERENCES Pessoa_Treinadora (Pessoa_Treinadora_ID),
    FOREIGN KEY (Horario_ID)
        REFERENCES Horario (Horario_ID),
    FOREIGN KEY (Modalidade_ID)
        REFERENCES Modalidade (Modalidade_ID)
...
INSERT INTO Plano ( Plano_ID, Nome_plano, Valor)
  VALUES 
    (1, 'Mensal', 90.00),
    (2, 'Trimestral', 210.00),
    (3, 'Semestral', 380.00),
...
INSERT INTO Horario (Horario_ID, Periodo)
  VALUES 
    (1, 'Manhã'),
    (2, 'Tarde'),
    (3, 'Noite');
    
INSERT INTO Modalidade (Modalidade_ID, Nome_modalidade)
  VALUES
    (1, 'Musculação'),
    (2, 'Natação'),
    (3, 'Dança'),
